...
# arreglo = [{"id":0, "data":1}, {"id":1,"data":2}, {"id":2,"data":3}]
schema_parametros = {
    'type': 'object',
    'properties': {
...
class Parametros(db.Model):
    ...
    # Constructor.
    def _init_(self, unidades, alertaAlto, alertaBajo, valorMaximo, valorMinimo, nombre):
...
class Mediciones(db.Model):
    ...
    # Constructor.
    def _init_(self, valor, idMedicion, idParametro):
...
#Constructor
    def _init_(self, numSerie, dirMac, modelo, marcaDispositivo, marcaSensor, nivel, edificio, precision, oficina):
